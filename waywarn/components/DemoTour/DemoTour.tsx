...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    symbols: [
      { icon: "🟢", color: "#22c55e", label: "Green Circle", desc: "Low severity hazard — reported by community" },
      { icon: "🟡", color: "#fbbf24", label: "Amber Circle", desc: "Medium severity hazard — drive carefully" },
      { icon: "🔴", color: "#ef4444", label: "Red Circle", desc: "High severity hazard — slow down now" },
      { icon: "◆", color: "#22c55e", label: "Green Diamond", desc: "AI-predicted low-risk pothole (pulsing = ML confident)" },
      { icon: "◆", color: "#fbbf24", label: "Amber Diamond", desc: "AI-predicted medium-risk pothole" },
      { icon: "◆", color: "#ef4444", label: "Red Diamond", desc: "AI-predicted high-risk pothole" },
  ...
  },
  {
    ...
    subtitle: "5 hazard types predicted by ML before you drive",
    body: "Our ML model scans the route and predicts potholes, cracks, waterlogging, construction zones, and speed breakers — even before drivers report them. Each emoji badge glows with a severity ring.",
    mockType: "aiDot",
    symbols: [
      { icon: "🕳️", color: "#ef4444", label: "Pothole",           desc: "AI-predicted road surface damage" },
      { icon: "⚠️", color: "#fbbf24", label: "Road Crack",         desc: "Fatigue or settlement cracking" },
      { icon: "💧", color: "#3b82f6", label: "Waterlogging",       desc: "Low-lying stretch — floods in rain" },
      { icon: "🚧", color: "#d97706", label: "Construction Zone",  desc: "Active work — lane narrowing likely" },
      { icon: "⛰️", color: "#a855f7", label: "Speed Breaker",      desc: "Unmarked or unofficial speed bump" },
      { icon: "🟢🟡🔴", label: "Glow ring colour", desc: "Green = low · Amber = medium · Red = high risk" },
    ],
  },
  {
    id: "nav-hud",
